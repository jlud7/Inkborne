...
void GameOfLifeActivity::render(RenderLock&&) {
  ...
  GUI.drawHeader(renderer, Rect{0, metrics.topPadding, pageWidth, metrics.headerHeight}, "Game of Life");
  ...
  const auto labels = mappedInput.mapLabels(tr(STR_BACK), "Toggle", tr(STR_DIR_UP), tr(STR_DIR_DOWN));
